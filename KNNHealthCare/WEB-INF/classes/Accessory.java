...
public class Accessory extends HttpServlet{
	...
	public Accessory(String productName, String productType, double productPrice, String productImage, String productManufacturer, String manufactureDate, String bestBeforeDate, String description, double discount, int originalProductquantity, int soldProductQuantity, int availableProductQuantity, double manufacturerRebate){
		//this.Id=Id;

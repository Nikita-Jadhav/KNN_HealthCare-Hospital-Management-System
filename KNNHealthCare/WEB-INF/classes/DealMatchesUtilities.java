...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("</li><li>");
		pw.print("<br><form action='Cart' method='post'><input type='submit' class='btn_viewpProfile1' value='Buy Now'>");
		...
		pw.print("</form></li><li>");
		pw.print("<br><form action='WriteReviewMedicine' method='post'><input type='submit' class='btn_review1' value='WriteReview'>"
